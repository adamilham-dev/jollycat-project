...
public final class ActivityHomeBinding implements ViewBinding {
  ...
  public static ActivityHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.layout_menu;
      CardView layoutMenu = ViewBindings.findChildViewById(rootView, id);
      if (layoutMenu == null) {
        break missingId;
      }

      return new ActivityHomeBinding((ConstraintLayout) rootView, bottomNav, container, layoutMenu);
    }
